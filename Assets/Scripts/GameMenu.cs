...
public class GameMenu : MonoBehaviour
{
    ...
    {
        UpdateMainStats();
        //update the information thst is shown
        StatusChar(0);
    ...
    public void StatusChar(int selected)
    {
        ...
        {
            statusEqWpn.text = playerStats[selected].equippedWeapon;
        }
        statusWpnPwr.text = playerStats[selected].weaponPower.ToString();
        if (playerStats[selected].equippedArmor != "")
        {
            statusEqArm.text = playerStats[selected].equippedArmor;
        }
